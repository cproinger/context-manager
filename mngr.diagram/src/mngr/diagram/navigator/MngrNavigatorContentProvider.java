...
import mngr.diagram.part.Messages;
 ...
 * @generated
 */
public class MngrNavigatorContentProvider implements ICommonContentProvider {
	...
	public MngrNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			Resource resource = myEditingDomain.getResourceSet().getResource(
					fileURI, true);
			ArrayList<MngrNavigatorItem> result = new ArrayList<MngrNavigatorItem>();
		...
		if (parentElement instanceof MngrNavigatorGroup) {
			MngrNavigatorGroup group = (MngrNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof MngrNavigatorItem) {
			MngrNavigatorItem navigatorItem = (MngrNavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case ManagerEditPart.VISUAL_ID: {
			...
			MngrNavigatorGroup links = new MngrNavigatorGroup(
					Messages.NavigatorGroupName_Manager_1000_links,
		...
		case ManagerParameterOpaqueExpressionsEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			MngrNavigatorGroup target = new MngrNavigatorGroup(
					Messages.NavigatorGroupName_ManagerParameterOpaqueExpressions_4003_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			MngrNavigatorGroup source = new MngrNavigatorGroup(
					Messages.NavigatorGroupName_ManagerParameterOpaqueExpressions_4003_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					MngrVisualIDRegistry
		...
		case ManagerTransitionEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			MngrNavigatorGroup target = new MngrNavigatorGroup(
					Messages.NavigatorGroupName_ManagerTransition_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			MngrNavigatorGroup source = new MngrNavigatorGroup(
					Messages.NavigatorGroupName_ManagerTransition_4001_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					MngrVisualIDRegistry
	 ...
	 * @generated
	 */
	private Collection<MngrNavigatorItem> createNavigatorItems(
			Collection<View> views, Object parent, boolean isLeafs) {
		ArrayList<MngrNavigatorItem> result = new ArrayList<MngrNavigatorItem>(
				views.size());
		for (View nextView : views) {
			result.add(new MngrNavigatorItem(nextView, parent, isLeafs));
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private Collection<MngrNavigatorItem> getForeignShortcuts(Diagram diagram,
			Object parent) {
		LinkedList<View> result = new LinkedList<View>();
	...
	public Object getParent(Object element) {
		if (element instanceof MngrAbstractNavigatorItem) {
			MngrAbstractNavigatorItem abstractNavigatorItem = (MngrAbstractNavigatorItem) element;
