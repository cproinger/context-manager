...
import mngr.diagram.edit.commands.MngrCreateShortcutDecorationsCommand;
import mngr.diagram.edit.policies.ManagerCanonicalEditPolicy;
import mngr.diagram.edit.policies.ManagerItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ManagerEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "Mngr"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ManagerItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ManagerCanonicalEditPolicy());
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new MngrCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
