...
import mngr.diagram.edit.commands.ManagerTransitionCreateCommand;
import mngr.diagram.edit.commands.ManagerTransitionReorientCommand;
 ...
 * @generated
 */
public class ManagerStateItemSemanticEditPolicy extends
		MngrBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ManagerStateItemSemanticEditPolicy() {
		super(MngrElementTypes.ManagerState_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (MngrVisualIDRegistry.getVisualID(incomingLink) == ManagerTransitionEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (MngrVisualIDRegistry.getVisualID(outgoingLink) == ManagerTransitionEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
			...
			if (MngrVisualIDRegistry.getVisualID(outgoingLink) == ManagerStateContextParametersEditPart.VISUAL_ID) {
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (MngrElementTypes.ManagerTransition_4001 == req.getElementType()) {
			return getGEFWrapper(new ManagerTransitionCreateCommand(req,
	...
	protected Command getReorientRelationshipCommand(
		...
		case ManagerTransitionEditPart.VISUAL_ID:
			return getGEFWrapper(new ManagerTransitionReorientCommand(req));
		}
