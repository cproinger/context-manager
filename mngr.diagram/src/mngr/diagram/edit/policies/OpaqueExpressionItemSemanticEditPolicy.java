 ...
 * @generated
 */
public class OpaqueExpressionItemSemanticEditPolicy extends
	...
	public OpaqueExpressionItemSemanticEditPolicy() {
		super(MngrElementTypes.OpaqueExpression_2004);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (MngrVisualIDRegistry.getVisualID(incomingLink) == ManagerParameterOpaqueExpressionsEditPart.VISUAL_ID) {
