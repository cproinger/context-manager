 ...
 * @generated
 */
public class MngrValidationDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = MngrDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof MngrDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& ManagerEditPart.MODEL_ID.equals(MngrVisualIDRegistry
						.getModelID(view));
	}
