 ...
 * @generated
 */
public class MngrViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return ManagerEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = MngrVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = MngrVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!MngrElementTypes.isKnownElementType(elementType)
				...
				if (!ManagerEditPart.MODEL_ID.equals(MngrVisualIDRegistry
		...
		return ManagerStateEditPart.VISUAL_ID == visualID
				|| ManagerParameterEditPart.VISUAL_ID == visualID
				|| ManagedElementEditPart.VISUAL_ID == visualID
				|| OpaqueExpressionEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = MngrVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != MngrVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(ManagerEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = MngrVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = MngrVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ManagerStateEditPart.VISUAL_ID:
			return createManagerState_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case ManagerParameterEditPart.VISUAL_ID:
			return createManagerParameter_2002(domainElement, containerView,
					index, persisted, preferencesHint);
		case ManagedElementEditPart.VISUAL_ID:
			return createManagedElement_2003(domainElement, containerView,
					index, persisted, preferencesHint);
		case OpaqueExpressionEditPart.VISUAL_ID:
			return createOpaqueExpression_2004(domainElement, containerView,
					index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (MngrVisualIDRegistry.getVisualID(elementTypeHint)) {
		case ManagerTransitionEditPart.VISUAL_ID:
			return createManagerTransition_4001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case ManagerStateContextParametersEditPart.VISUAL_ID:
			return createManagerStateContextParameters_4002(containerView,
					index, persisted, preferencesHint);
		case ManagerParameterOpaqueExpressionsEditPart.VISUAL_ID:
			return createManagerParameterOpaqueExpressions_4003(containerView,
					index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createManagerState_2001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MngrVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createManagerParameter_2002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createManagedElement_2003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MngrVisualIDRegistry
				.getType(ManagedElementEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createOpaqueExpression_2004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MngrVisualIDRegistry
				.getType(OpaqueExpressionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Edge createManagerTransition_4001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setType(MngrVisualIDRegistry
		...
		Node label6002 = createLabel(edge,
				MngrVisualIDRegistry
						.getType(ManagerTransitionActionEditPart.VISUAL_ID));
		...
		Node label6003 = createLabel(edge,
				MngrVisualIDRegistry
						.getType(ManagerTransitionConditionEditPart.VISUAL_ID));
		...
		Node label6004 = createLabel(edge,
				MngrVisualIDRegistry
						.getType(ManagerTransitionEventEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createManagerStateContextParameters_4002(View containerView,
		...
		Node label6005 = createLabel(edge,
				MngrVisualIDRegistry.getType(WrappingLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createManagerParameterOpaqueExpressions_4003(
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		...
		Node label6006 = createLabel(edge,
				MngrVisualIDRegistry.getType(WrappingLabel2EditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!ManagerEditPart.MODEL_ID.equals(MngrVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", ManagerEditPart.MODEL_ID); //$NON-NLS-1$
