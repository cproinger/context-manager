 ...
 * @generated
 */
public class MngrElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public MngrElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.MngrElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "mngr".equals(fileExtension); //$NON-NLS-1$
	}
