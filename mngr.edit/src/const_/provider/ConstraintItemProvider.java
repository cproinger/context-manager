...
/**
 * This is the item provider adapter for a {@link const_.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConstPackage.Literals.CONSTRAINT__CONSTRAINED_ELEMENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConstPackage.Literals.CONSTRAINT__SPECIFICATION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Constraint.class)) {
			case ConstPackage.CONSTRAINT__SPECIFICATION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConstPackage.Literals.CONSTRAINT__SPECIFICATION,
				 ExpFactory.eINSTANCE.createExpression()));
