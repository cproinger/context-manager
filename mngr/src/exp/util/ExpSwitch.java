	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ExpPackage.EXPRESSION: {
				...
				if (result == null) result = caseOwner_Element(expression);
				if (result == null) result = caseElement(expression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExpPackage.OPAQUE_EXPRESSION: {
				...
				if (result == null) result = caseOwner_Element(opaqueExpression);
